...
This data is an extract from @owid-carbon-deforestation-trade. It presents the emission from converting forest land to rice, wheat, and other cereal products for different countries. The data for this project is available at []().
...
This data is from the DAAG package by @maindonald2015package. It presents measurement on 120 eggs lain in the nest of 6 different species of cuckoos. The data for this project is available at []().
