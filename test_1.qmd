...
subtitle: "R for Research Test I (26th July, 2024)"
format: html
filters: 
 - webr
engine: knitr
...
# Instructions
Wait until `WEBR status` is **Ready**. Ideally it takes less than a seconds. You have twenty minutes to answer the questions. Do not reload the page. If you do, you lose your progress. **Good luck!!**
